...
class myProviderSelection(ChannelSelectionBase):
    ...
    def __init__(self, session, title):
        ...
        self['actions'] = ActionMap(['OkCancelActions', 'ChannelSelectBaseActions'], {'showFavourites': self.doNothing,
...
class myChannelSelection(ChannelSelectionBase):
    ...
    def __init__(self, session, title):
        ChannelSelectionBase.__init__(self, session)
        self.onShown.append(self.__onExecCallback)
        self['actions'] = ActionMap(['OkCancelActions', 'TvRadioActions', 'ChannelSelectBaseActions'], {'showProviders': self.doNothing,
